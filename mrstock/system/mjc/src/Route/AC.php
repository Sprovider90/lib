...
class AC
{
    ...
    protected function parseVersion(){
        ...
        if (isset($this->app->request->param[self::VERSIOIN_PARAM]) && !empty($this->app->request->param[self::VERSIOIN_PARAM])) {
            $this->currVersion = $this->app->request->param[self::VERSIOIN_PARAM];
