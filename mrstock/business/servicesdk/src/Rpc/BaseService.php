...
use MrStock\Business\ServiceSdk\Consulfabio\ConsulfabioFactory;
use MrStock\Business\ServiceSdk\Phptool\PhptoolFactory;
use MrStock\Business\ServiceSdk\Rpc\Exception\EnvParseException;
use MrStock\Business\ServiceSdk\Rpc\Exception\ConnectionErrorException;
...
class BaseService
{
     ...
     */
    public function __construct(IrpcService $stratege,$vendor_ip_cmd,$worker_name,$worker_count,$vendor_siterpc_url,$vendor_siterpc_suffix="")
    {
    ...
    {
        try{
            $this->port=PhptoolFactory::getport($this->worker_name);
        } catch (\Exception $e) {
