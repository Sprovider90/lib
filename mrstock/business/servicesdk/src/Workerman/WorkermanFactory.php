<?php
/*consul*/
namespace MrStock\Business\ServiceSdk\Workerman;
...
class WorkermanFactory
{
    ...
    public static function creatework($vendor_worker_ipport,$vendor_worker_count,$vendor_worker_name,$vendor_siterpc_url,$vendor_siterpc_suffix,$ip){
        ...
        //    $log = json_encode(['client_id' => "client_id closed"]);
            // \Mrstock\Mjc\Facade\Log::write($log, LogLevel::ERR);
        //    file_put_contents('/data/logs/kevin.log', $log, FILE_APPEND);
        //};
    }
