 ...
 * under the License.
 */
namespace MrStock\Business\ServiceSdk\Aliyun\Core\Profile;
use MrStock\Business\ServiceSdk\Aliyun\Core\Auth\BearerTokenCredential;
use MrStock\Business\ServiceSdk\Aliyun\Core\Auth\BearTokenSigner;
use MrStock\Business\ServiceSdk\Aliyun\Core\Auth\Credential;
use MrStock\Business\ServiceSdk\Aliyun\Core\Auth\EcsRamRoleCredential;
use MrStock\Business\ServiceSdk\Aliyun\Core\Auth\RamRoleArnCredential;
use MrStock\Business\ServiceSdk\Aliyun\Core\Auth\ShaHmac1Signer;
use MrStock\Business\ServiceSdk\Aliyun\Core\Regions\Endpoint;
use MrStock\Business\ServiceSdk\Aliyun\Core\Regions\EndpointProvider;
use MrStock\Business\ServiceSdk\Aliyun\Core\Regions\LocationService;
use MrStock\Business\ServiceSdk\Aliyun\Core\Regions\ProductDomain;

/**
 *
 */
defined('AUTH_TYPE_RAM_AK') or define('AUTH_TYPE_RAM_AK', 'RAM_AK');
/**
 *
 */
defined('AUTH_TYPE_RAM_ROLE_ARN') or define('AUTH_TYPE_RAM_ROLE_ARN', 'RAM_ROLE_ARN');
/**
 *
 */
defined('AUTH_TYPE_ECS_RAM_ROLE') or define('AUTH_TYPE_ECS_RAM_ROLE', 'ECS_RAM_ROLE');
/**
 *
 */
defined('AUTH_TYPE_BEARER_TOKEN') or define('AUTH_TYPE_BEARER_TOKEN', 'BEARER_TOKEN');
