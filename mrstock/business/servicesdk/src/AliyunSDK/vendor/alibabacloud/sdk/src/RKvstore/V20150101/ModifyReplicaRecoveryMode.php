 ...
 */
class ModifyReplicaRecoveryMode extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withRecoveryMode() instead.
     *
    ...
    {
        return $this->withRecoveryMode($recoveryMode);
    }
