 ...
 */
class InnerNetworkModifyValidation extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'InnerNetworkModifyValidation';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withNetworkValidation() instead.
     *
    ...
    {
        return $this->withNetworkValidation($networkValidation);
    }
     ...
     * @return $this
     */
    public function withNetworkValidation($networkValidation)
    {
        $this->data['NetworkValidation'] = $networkValidation;
        $this->options['query']['networkValidation'] = $networkValidation;
