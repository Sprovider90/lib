 ...
 */
class DescribeReplicas extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withAttachDbInstanceData() instead.
     *
    ...
    {
        return $this->withAttachDbInstanceData($attachDbInstanceData);
    }
