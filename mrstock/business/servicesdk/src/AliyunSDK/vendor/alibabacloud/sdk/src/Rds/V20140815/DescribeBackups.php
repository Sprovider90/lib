...
class DescribeBackups extends RpcRequest
{
     ...
     * @return $this
     */
    public function withBackupStatus($backupStatus)
    {
        $this->data['BackupStatus'] = $backupStatus;
     ...
     * @return $this
     */
    public function withBackupLocation($backupLocation)
    {
        $this->data['BackupLocation'] = $backupLocation;
        $this->options['query']['BackupLocation'] = $backupLocation;
