 ...
 */
class SubmitVideoGifJob extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withVideoGifConfig() instead.
     *
    ...
    {
        return $this->withVideoGifConfig($videoGifConfig);
    }
     ...
     * @return $this
     */
    public function withVideoGifConfig($videoGifConfig)
    {
        $this->data['VideoGifConfig'] = $videoGifConfig;
        $this->options['query']['VideoGifConfig'] = $videoGifConfig;
