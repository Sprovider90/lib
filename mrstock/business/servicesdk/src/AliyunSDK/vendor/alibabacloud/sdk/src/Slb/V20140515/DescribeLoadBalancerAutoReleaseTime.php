...
/**
 * Request of DescribeLoadBalancerAutoReleaseTime
 *
 ...
 */
class DescribeLoadBalancerAutoReleaseTime extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'DescribeLoadBalancerAutoReleaseTime';
