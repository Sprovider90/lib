...
/**
 * Request of RemoveVServerGroupBackendServersAsyn
 *
 ...
 */
class RemoveVServerGroupBackendServersAsyn extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'RemoveVServerGroupBackendServersAsyn';
