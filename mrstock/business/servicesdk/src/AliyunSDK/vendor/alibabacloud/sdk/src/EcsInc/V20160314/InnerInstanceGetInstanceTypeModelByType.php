 ...
 */
class InnerInstanceGetInstanceTypeModelByType extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'InnerInstanceGetInstanceTypeModelByType';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withIncludeOffline() instead.
     *
    ...
    {
        return $this->withIncludeOffline($includeOffline);
    }
