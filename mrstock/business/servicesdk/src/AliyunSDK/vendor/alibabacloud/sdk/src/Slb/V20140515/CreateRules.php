 ...
 */
class CreateRules extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withRuleList() instead.
     *
    ...
    {
        return $this->withRuleList($ruleList);
    }
