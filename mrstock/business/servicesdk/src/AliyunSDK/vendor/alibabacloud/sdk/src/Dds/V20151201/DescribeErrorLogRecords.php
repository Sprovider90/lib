 ...
 */
class DescribeErrorLogRecords extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'DescribeErrorLogRecords';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withRoleType() instead.
     *
    ...
    {
        return $this->withRoleType($roleType);
    }
     ...
     * @return $this
     */
    public function withRoleType($roleType)
    {
        $this->data['RoleType'] = $roleType;
        $this->options['query']['RoleType'] = $roleType;
