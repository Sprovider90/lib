 ...
 */
class CreatePhysicalConnectionNew extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'CreatePhysicalConnectionNew';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withInterfaceName() instead.
     *
    ...
    {
        return $this->withInterfaceName($interfaceName);
    }
     ...
     * @return $this
     */
    public function withInterfaceName($interfaceName)
    {
        $this->data['InterfaceName'] = $interfaceName;
        $this->options['query']['InterfaceName'] = $interfaceName;
