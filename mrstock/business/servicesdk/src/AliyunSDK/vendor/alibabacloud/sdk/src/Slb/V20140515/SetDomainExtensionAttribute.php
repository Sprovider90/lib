...
/**
 * Request of SetDomainExtensionAttribute
 *
 ...
 */
class SetDomainExtensionAttribute extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withDomainExtensionId() instead.
     *
    ...
    {
        return $this->withDomainExtensionId($domainExtensionId);
    }
     ...
     * @return $this
     */
    public function withDomainExtensionId($domainExtensionId)
    {
        $this->data['DomainExtensionId'] = $domainExtensionId;
        $this->options['query']['DomainExtensionId'] = $domainExtensionId;
