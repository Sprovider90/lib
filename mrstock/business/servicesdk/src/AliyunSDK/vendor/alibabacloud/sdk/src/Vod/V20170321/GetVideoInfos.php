 ...
 */
class GetVideoInfos extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withVideoIds() instead.
     *
    ...
    {
        return $this->withVideoIds($videoIds);
    }
