 ...
 */
class UpdateMediaWorkflowTriggerMode extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withTriggerMode() instead.
     *
    ...
    {
        return $this->withTriggerMode($triggerMode);
    }
