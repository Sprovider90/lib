...
class DescribeKeyPairs extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withKeyPairFingerPrint() instead.
     *
    ...
    {
        return $this->withKeyPairFingerPrint($keyPairFingerPrint);
    }
     ...
     * @return $this
     */
    public function withKeyPairFingerPrint($keyPairFingerPrint)
    {
        $this->data['KeyPairFingerPrint'] = $keyPairFingerPrint;
        $this->options['query']['KeyPairFingerPrint'] = $keyPairFingerPrint;
