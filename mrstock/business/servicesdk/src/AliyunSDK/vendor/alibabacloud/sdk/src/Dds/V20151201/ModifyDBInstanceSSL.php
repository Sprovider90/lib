 ...
 */
class ModifyDBInstanceSSL extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withSSLAction() instead.
     *
    ...
    {
        return $this->withSSLAction($sSLAction);
    }
     ...
     * @return $this
     */
    public function withSSLAction($sSLAction)
    {
        $this->data['SSLAction'] = $sSLAction;
        $this->options['query']['SSLAction'] = $sSLAction;
