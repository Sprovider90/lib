...
/**
 * Request of DescribeAdvisorCheckItems
 *
 ...
 */
class DescribeAdvisorCheckItems extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'DescribeAdvisorCheckItems';
    ...
    {
        return $this->withCheckId($checkId);
    }
     ...
     * @return $this
     */
    public function withCheckId($checkId)
    {
        $this->data['CheckId'] = $checkId;
        $this->options['query']['CheckId'] = $checkId;
