...
/**
 * Request of RemoveAccessControlListEntry
 *
 ...
 */
class RemoveAccessControlListEntry extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'RemoveAccessControlListEntry';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withAclEntrys() instead.
     *
     * @param string $aclEntrys
     *
     * @return $this
     */
    public function setAclEntrys($aclEntrys)
    {
        return $this->withAclEntrys($aclEntrys);
    }
     ...
     * @return $this
     */
    public function withAclEntrys($aclEntrys)
    {
        $this->data['AclEntrys'] = $aclEntrys;
        $this->options['query']['AclEntrys'] = $aclEntrys;
