...
/**
 * Request of InnerUpdateEntityConstraints
 *
 ...
 */
class InnerUpdateEntityConstraints extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'InnerUpdateEntityConstraints';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withReplaceAll() instead.
     *
    ...
    {
        return $this->withReplaceAll($replaceAll);
    }
