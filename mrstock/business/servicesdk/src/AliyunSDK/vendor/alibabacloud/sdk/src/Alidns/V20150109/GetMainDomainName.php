 ...
 */
class GetMainDomainName extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'GetMainDomainName';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withInputString() instead.
     *
    ...
    {
        return $this->withInputString($inputString);
    }
