...
/**
 * Request of DescribeLoadBalancerTCPListenerAttribute
 *
 ...
 */
class DescribeLoadBalancerTCPListenerAttribute extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'DescribeLoadBalancerTCPListenerAttribute';
