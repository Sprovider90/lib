 ...
 */
class ExecuteScalingRule extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withScalingRuleAri() instead.
     *
    ...
    {
        return $this->withScalingRuleAri($scalingRuleAri);
    }
