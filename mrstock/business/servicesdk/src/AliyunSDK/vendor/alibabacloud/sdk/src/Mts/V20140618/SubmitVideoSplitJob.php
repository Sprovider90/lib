 ...
 */
class SubmitVideoSplitJob extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withVideoSplitConfig() instead.
     *
    ...
    {
        return $this->withVideoSplitConfig($videoSplitConfig);
    }
     ...
     * @return $this
     */
    public function withVideoSplitConfig($videoSplitConfig)
    {
        $this->data['VideoSplitConfig'] = $videoSplitConfig;
        $this->options['query']['VideoSplitConfig'] = $videoSplitConfig;
