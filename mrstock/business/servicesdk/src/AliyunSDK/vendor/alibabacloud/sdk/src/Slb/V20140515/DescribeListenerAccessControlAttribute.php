...
/**
 * Request of DescribeListenerAccessControlAttribute
 *
 ...
 */
class DescribeListenerAccessControlAttribute extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'DescribeListenerAccessControlAttribute';
