 ...
 */
class SubmitAsrJob extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withAsrConfig() instead.
     *
    ...
    {
        return $this->withAsrConfig($asrConfig);
    }
     ...
     * @return $this
     */
    public function withAsrConfig($asrConfig)
    {
        $this->data['AsrConfig'] = $asrConfig;
        $this->options['query']['AsrConfig'] = $asrConfig;
