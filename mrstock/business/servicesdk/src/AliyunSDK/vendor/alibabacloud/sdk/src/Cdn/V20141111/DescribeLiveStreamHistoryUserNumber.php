...
/**
 * Request of DescribeLiveStreamHistoryUserNumber
 *
 ...
 */
class DescribeLiveStreamHistoryUserNumber extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'DescribeLiveStreamHistoryUserNumber';
