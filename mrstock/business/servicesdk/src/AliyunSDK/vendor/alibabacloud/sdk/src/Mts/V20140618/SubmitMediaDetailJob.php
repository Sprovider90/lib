 ...
 */
class SubmitMediaDetailJob extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withMediaDetailConfig() instead.
     *
    ...
    {
        return $this->withMediaDetailConfig($mediaDetailConfig);
    }
     ...
     * @return $this
     */
    public function withMediaDetailConfig($mediaDetailConfig)
    {
        $this->data['MediaDetailConfig'] = $mediaDetailConfig;
        $this->options['query']['MediaDetailConfig'] = $mediaDetailConfig;
