 ...
 */
class InnerEcsResourceGroupQueryByResources extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'InnerEcsResourceGroupQueryByResources';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withResourceIds() instead.
     *
    ...
    {
        return $this->withResourceIds($resourceIds);
    }
