 ...
 */
class DeleteACLRule extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withAcrId() instead.
     *
     * @param string $acrId
     *
     * @return $this
