 ...
 */
class InnerDiskResizeByParam extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'InnerDiskResizeByParam';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withNewSize() instead.
     *
    ...
    {
        return $this->withNewSize($newSize);
    }
     ...
     * @return $this
     */
    public function withNewSize($newSize)
    {
        $this->data['NewSize'] = $newSize;
        $this->options['query']['newSize'] = $newSize;
