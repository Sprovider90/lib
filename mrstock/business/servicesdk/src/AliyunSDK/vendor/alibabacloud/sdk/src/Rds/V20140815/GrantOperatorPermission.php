 ...
 */
class GrantOperatorPermission extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withPrivileges() instead.
     *
    ...
    {
        return $this->withPrivileges($privileges);
    }
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withExpiredTime() instead.
     *
    ...
    {
        return $this->withExpiredTime($expiredTime);
    }
