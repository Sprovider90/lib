...
/**
 * Request of ModifyVServerGroupBackendServersAsyn
 *
 ...
 */
class ModifyVServerGroupBackendServersAsyn extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'ModifyVServerGroupBackendServersAsyn';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withOldBackendServers() instead.
     *
     * @param string $oldBackendServers
     *
     * @return $this
     */
    public function setOldBackendServers($oldBackendServers)
    {
        return $this->withOldBackendServers($oldBackendServers);
    }
     ...
     * @return $this
     */
    public function withOldBackendServers($oldBackendServers)
    {
        $this->data['OldBackendServers'] = $oldBackendServers;
        $this->options['query']['OldBackendServers'] = $oldBackendServers;
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withNewBackendServers() instead.
     *
     * @param string $newBackendServers
     *
     * @return $this
     */
    public function setNewBackendServers($newBackendServers)
    {
        return $this->withNewBackendServers($newBackendServers);
    }
     ...
     * @return $this
     */
    public function withNewBackendServers($newBackendServers)
    {
        $this->data['NewBackendServers'] = $newBackendServers;
        $this->options['query']['NewBackendServers'] = $newBackendServers;
