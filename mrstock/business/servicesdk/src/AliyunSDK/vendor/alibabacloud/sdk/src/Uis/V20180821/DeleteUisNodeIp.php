 ...
 */
class DeleteUisNodeIp extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withUisNodeIpAddress() instead.
     *
    ...
    {
        return $this->withUisNodeIpAddress($uisNodeIpAddress);
    }
