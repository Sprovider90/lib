 ...
 */
class ReportVideoSplitJobResult extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'ReportVideoSplitJobResult';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withResult() instead.
     *
     * @param string $result
     *
     * @return $this
    ...
    public function withResult($result)
    {
        ...
        $this->options['query']['Result'] = $result;
