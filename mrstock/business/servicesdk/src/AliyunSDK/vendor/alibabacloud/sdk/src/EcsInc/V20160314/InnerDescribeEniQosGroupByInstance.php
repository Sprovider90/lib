...
/**
 * Request of InnerDescribeEniQosGroupByInstance
 *
 ...
 */
class InnerDescribeEniQosGroupByInstance extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'InnerDescribeEniQosGroupByInstance';
