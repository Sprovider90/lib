 ...
 */
class DecryptKey extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withCiphertextBlob() instead.
     *
    ...
    {
        return $this->withCiphertextBlob($ciphertextBlob);
    }
