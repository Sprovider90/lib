...
/**
 * Request of ModifyUisConnectionAttribute
 *
 ...
 */
class ModifyUisConnectionAttribute extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'ModifyUisConnectionAttribute';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withUisConnectionId() instead.
     *
    ...
    {
        return $this->withUisConnectionId($uisConnectionId);
    }
