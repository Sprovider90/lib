 ...
 */
class InnerEcsSnapshotQueryAllSnapshotsByEcsId extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'InnerEcsSnapshotQueryAllSnapshotsByEcsId';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withEcsId() instead.
     *
     * @param string $ecsId
     *
     * @return $this
     ...
     * @return $this
     */
    public function withEcsId($ecsId)
    {
        $this->data['EcsId'] = $ecsId;
        $this->options['query']['ecsId'] = $ecsId;
