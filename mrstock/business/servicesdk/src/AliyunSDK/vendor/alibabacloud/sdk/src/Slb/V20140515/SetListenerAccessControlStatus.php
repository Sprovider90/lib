...
class SetListenerAccessControlStatus extends RpcRequest
{
     ...
     * @return $this
     */
    public function withAccessControlStatus($accessControlStatus)
    {
        $this->data['AccessControlStatus'] = $accessControlStatus;
        $this->options['query']['AccessControlStatus'] = $accessControlStatus;
