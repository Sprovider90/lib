 ...
 */
class ImportDatabaseBetweenInstances extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withDBInfo() instead.
     *
     * @param string $dBInfo
     *
     * @return $this
     ...
     * @return $this
     */
    public function withDBInfo($dBInfo)
    {
        $this->data['DBInfo'] = $dBInfo;
        $this->options['query']['DBInfo'] = $dBInfo;
