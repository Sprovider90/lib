...
class DescribePrice extends RpcRequest
{
     ...
     * @return $this
     */
    public function withOfferingType($offeringType)
    {
        $this->data['OfferingType'] = $offeringType;
     ...
     * @return $this
     */
    public function withInstanceAmount($instanceAmount)
    {
        $this->data['InstanceAmount'] = $instanceAmount;
        $this->options['query']['InstanceAmount'] = $instanceAmount;
