 ...
 */
class InnerImageDetail extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'InnerImageDetail';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withIncludeDeleted() instead.
     *
    ...
    {
        return $this->withIncludeDeleted($includeDeleted);
    }
     ...
     * @return $this
     */
    public function withIncludeDeleted($includeDeleted)
    {
        $this->data['IncludeDeleted'] = $includeDeleted;
        $this->options['query']['includeDeleted'] = $includeDeleted;
