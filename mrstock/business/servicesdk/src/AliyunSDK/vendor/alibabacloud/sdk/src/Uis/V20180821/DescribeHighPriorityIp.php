...
/**
 * Request of DescribeHighPriorityIp
 *
 ...
 */
class DescribeHighPriorityIp extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'DescribeHighPriorityIp';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withHighPriorityIp() instead.
     *
    ...
    {
        return $this->withHighPriorityIp($highPriorityIp);
    }
