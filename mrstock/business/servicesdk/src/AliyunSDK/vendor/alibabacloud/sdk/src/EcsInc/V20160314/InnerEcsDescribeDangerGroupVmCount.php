...
/**
 * Request of InnerEcsDescribeDangerGroupVmCount
 *
 ...
 */
class InnerEcsDescribeDangerGroupVmCount extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'InnerEcsDescribeDangerGroupVmCount';
