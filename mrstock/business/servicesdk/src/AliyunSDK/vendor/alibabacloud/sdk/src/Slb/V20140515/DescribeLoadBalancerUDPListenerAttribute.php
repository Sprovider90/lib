...
/**
 * Request of DescribeLoadBalancerUDPListenerAttribute
 *
 ...
 */
class DescribeLoadBalancerUDPListenerAttribute extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'DescribeLoadBalancerUDPListenerAttribute';
