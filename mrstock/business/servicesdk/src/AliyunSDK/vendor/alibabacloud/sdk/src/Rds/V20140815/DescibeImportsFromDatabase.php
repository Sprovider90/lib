 ...
 */
class DescibeImportsFromDatabase extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withImportId() instead.
     *
    ...
    {
        return $this->withImportId($importId);
    }
     ...
     * @return $this
     */
    public function withImportId($importId)
    {
        $this->data['ImportId'] = $importId;
        $this->options['query']['ImportId'] = $importId;
