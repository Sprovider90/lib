...
class ModifyDBInstanceMaintainTime extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withMaintainTime() instead.
     *
    ...
    {
        return $this->withMaintainTime($maintainTime);
    }
     ...
     * @return $this
     */
    public function withMaintainTime($maintainTime)
    {
        $this->data['MaintainTime'] = $maintainTime;
        $this->options['query']['MaintainTime'] = $maintainTime;
