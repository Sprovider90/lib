...
/**
 * Request of SendMailUseTemplate
 *
 ...
 */
class SendMailUseTemplate extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'SendMailUseTemplate';
     ...
     * @return $this
     */
    public function withTemplateContent($templateContent)
    {
        $this->data['TemplateContent'] = $templateContent;
        $this->options['query']['TemplateContent'] = $templateContent;
     ...
     * @return $this
     */
    public function withToAlias($toAlias)
    {
        $this->data['ToAlias'] = $toAlias;
        $this->options['query']['ToAlias'] = $toAlias;
