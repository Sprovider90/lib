 ...
 */
class QuerySnapshotJobList extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withSnapshotJobIds() instead.
     *
    ...
    {
        return $this->withSnapshotJobIds($snapshotJobIds);
    }
     ...
     * @return $this
     */
    public function withSnapshotJobIds($snapshotJobIds)
    {
        $this->data['SnapshotJobIds'] = $snapshotJobIds;
        $this->options['query']['SnapshotJobIds'] = $snapshotJobIds;
