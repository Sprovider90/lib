 ...
 */
class QueryImageCopyProgress extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'QueryImageCopyProgress';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withImageRegionNo() instead.
     *
    ...
    {
        return $this->withImageRegionNo($imageRegionNo);
    }
