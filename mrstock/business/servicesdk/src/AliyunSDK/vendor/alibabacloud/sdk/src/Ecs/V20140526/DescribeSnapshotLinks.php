 ...
 */
class DescribeSnapshotLinks extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withSnapshotLinkIds() instead.
     *
    ...
    {
        return $this->withSnapshotLinkIds($snapshotLinkIds);
    }
     ...
     * @return $this
     */
    public function withSnapshotLinkIds($snapshotLinkIds)
    {
        $this->data['SnapshotLinkIds'] = $snapshotLinkIds;
        $this->options['query']['SnapshotLinkIds'] = $snapshotLinkIds;
