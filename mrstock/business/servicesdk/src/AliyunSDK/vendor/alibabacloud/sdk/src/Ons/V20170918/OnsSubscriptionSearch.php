...
/**
 * Request of OnsSubscriptionSearch
 *
 ...
 */
class OnsSubscriptionSearch extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'OnsSubscriptionSearch';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withSearch() instead.
     *
     * @param string $search
     *
     * @return $this
    ...
    public function withSearch($search)
    {
        ...
        $this->options['query']['Search'] = $search;
