...
class CreateMasterSlaveVServerGroup extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withMasterSlaveVServerGroupName() instead.
     *
    ...
    {
        return $this->withMasterSlaveVServerGroupName($masterSlaveVServerGroupName);
    }
