 ...
 */
class ModifySecurityGroupPolicy extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withInnerAccessPolicy() instead.
     *
    ...
    {
        return $this->withInnerAccessPolicy($innerAccessPolicy);
    }
     ...
     * @return $this
     */
    public function withInnerAccessPolicy($innerAccessPolicy)
    {
        $this->data['InnerAccessPolicy'] = $innerAccessPolicy;
        $this->options['query']['InnerAccessPolicy'] = $innerAccessPolicy;
