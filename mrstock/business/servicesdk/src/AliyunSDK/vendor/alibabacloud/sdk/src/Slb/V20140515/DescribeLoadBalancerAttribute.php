...
/**
 * Request of DescribeLoadBalancerAttribute
 *
 ...
 */
class DescribeLoadBalancerAttribute extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'DescribeLoadBalancerAttribute';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withIncludeReservedData() instead.
     *
     * @param string $includeReservedData
     *
     * @return $this
     */
    public function setIncludeReservedData($includeReservedData)
    {
        return $this->withIncludeReservedData($includeReservedData);
    }
     ...
     * @return $this
     */
    public function withIncludeReservedData($includeReservedData)
    {
        $this->data['IncludeReservedData'] = $includeReservedData;
        $this->options['query']['IncludeReservedData'] = $includeReservedData;
