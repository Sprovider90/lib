 ...
 */
class InnerEcsQuerySecurity extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'InnerEcsQuerySecurity';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withEcsGroupNic() instead.
     *
    ...
    {
        return $this->withEcsGroupNic($ecsGroupNic);
    }
     ...
     * @return $this
     */
    public function withEcsGroupNic($ecsGroupNic)
    {
        $this->data['EcsGroupNic'] = $ecsGroupNic;
        $this->options['query']['ecsGroupNic'] = $ecsGroupNic;
