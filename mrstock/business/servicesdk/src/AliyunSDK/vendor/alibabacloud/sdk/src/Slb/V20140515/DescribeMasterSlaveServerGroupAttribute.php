...
/**
 * Request of DescribeMasterSlaveServerGroupAttribute
 *
 ...
 */
class DescribeMasterSlaveServerGroupAttribute extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'DescribeMasterSlaveServerGroupAttribute';
