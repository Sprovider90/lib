 ...
 */
class UpdateMediaPublishState extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withPublish() instead.
     *
    ...
    {
        return $this->withPublish($publish);
    }
    ...
    public function withPublish($publish)
    {
        ...
        $this->options['query']['Publish'] = $publish;
