 ...
 */
class ModifyScheduledTask extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withScheduledTaskId() instead.
     *
    ...
    {
        return $this->withScheduledTaskId($scheduledTaskId);
    }
