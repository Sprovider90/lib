...
/**
 * Request of CreateLoadBalancerHTTPListenerAsyn
 *
 ...
 */
class CreateLoadBalancerHTTPListenerAsyn extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'CreateLoadBalancerHTTPListenerAsyn';
