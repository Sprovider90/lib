...
/**
 * Request of DetailCenterResourceAtOrigin
 *
 ...
 */
class DetailCenterResourceAtOrigin extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'DetailCenterResourceAtOrigin';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withCenterResourceId() instead.
     *
     * @param string $centerResourceId
     *
     * @return $this
     */
    public function setCenterResourceId($centerResourceId)
    {
        return $this->withCenterResourceId($centerResourceId);
    }
