 ...
 */
class SubmitKwsJob extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withKwsConfig() instead.
     *
     * @param string $kwsConfig
     *
     * @return $this
     */
    public function setKwsConfig($kwsConfig)
    {
        return $this->withKwsConfig($kwsConfig);
    }
     ...
     * @return $this
     */
    public function withKwsConfig($kwsConfig)
    {
        $this->data['KwsConfig'] = $kwsConfig;
        $this->options['query']['KwsConfig'] = $kwsConfig;
