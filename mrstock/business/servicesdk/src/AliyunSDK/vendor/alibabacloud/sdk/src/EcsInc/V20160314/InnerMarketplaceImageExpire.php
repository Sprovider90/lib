 ...
 */
class InnerMarketplaceImageExpire extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'InnerMarketplaceImageExpire';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withImageInstanceId() instead.
     *
    ...
    {
        return $this->withImageInstanceId($imageInstanceId);
    }
     ...
     * @return $this
     */
    public function withImageInstanceId($imageInstanceId)
    {
        $this->data['ImageInstanceId'] = $imageInstanceId;
        $this->options['query']['ImageInstanceId'] = $imageInstanceId;
