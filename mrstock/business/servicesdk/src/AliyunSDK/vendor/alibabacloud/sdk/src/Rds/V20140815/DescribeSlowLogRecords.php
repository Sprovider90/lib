 ...
 */
class DescribeSlowLogRecords extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'DescribeSlowLogRecords';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withSQLId() instead.
     *
     * @param string $sQLId
     *
     * @return $this
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withSQLHASH() instead.
     *
    ...
    {
        return $this->withSQLHASH($sQLHASH);
    }
     ...
     * @return $this
     */
    public function withSQLHASH($sQLHASH)
    {
        $this->data['SQLHASH'] = $sQLHASH;
        $this->options['query']['SQLHASH'] = $sQLHASH;
