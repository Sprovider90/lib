...
/**
 * Request of OnsMqttQueryTraceByTraceId
 *
 ...
 */
class OnsMqttQueryTraceByTraceId extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'OnsMqttQueryTraceByTraceId';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withTraceId() instead.
     *
    ...
    {
        return $this->withTraceId($traceId);
    }
