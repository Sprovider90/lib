 ...
 */
class QueryImageByImageId extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'QueryImageByImageId';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use getImageId() instead.
     *
     * @return array
     */
    ...
    {
        return $this->withImageId($imageIds);
    }
