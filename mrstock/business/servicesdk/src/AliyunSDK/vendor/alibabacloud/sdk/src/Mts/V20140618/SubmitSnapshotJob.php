...
class SubmitSnapshotJob extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withSnapshotConfig() instead.
     *
    ...
    {
        return $this->withSnapshotConfig($snapshotConfig);
    }
     ...
     * @return $this
     */
    public function withSnapshotConfig($snapshotConfig)
    {
        $this->data['SnapshotConfig'] = $snapshotConfig;
        $this->options['query']['SnapshotConfig'] = $snapshotConfig;
