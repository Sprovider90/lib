...
/**
 * Request of CreateLoadBalancerHTTPSListenerAsyn
 *
 ...
 */
class CreateLoadBalancerHTTPSListenerAsyn extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'CreateLoadBalancerHTTPSListenerAsyn';
