 ...
 */
class ModifyReplicaVerificationMode extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withVerificationMode() instead.
     *
    ...
    {
        return $this->withVerificationMode($verificationMode);
    }
     ...
     * @return $this
     */
    public function withVerificationMode($verificationMode)
    {
        $this->data['VerificationMode'] = $verificationMode;
        $this->options['query']['VerificationMode'] = $verificationMode;
