...
/**
 * Request of DescribeCertificateRelatedListenersAndRules
 *
 ...
 */
class DescribeCertificateRelatedListenersAndRules extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'DescribeCertificateRelatedListenersAndRules';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withCertificateId() instead.
     *
    ...
    {
        return $this->withCertificateId($certificateId);
    }
