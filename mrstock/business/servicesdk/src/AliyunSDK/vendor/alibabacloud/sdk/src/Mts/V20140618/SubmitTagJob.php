 ...
 */
class SubmitTagJob extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withTagConfig() instead.
     *
    ...
    {
        return $this->withTagConfig($tagConfig);
    }
     ...
     * @return $this
     */
    public function withTagConfig($tagConfig)
    {
        $this->data['TagConfig'] = $tagConfig;
        $this->options['query']['TagConfig'] = $tagConfig;
