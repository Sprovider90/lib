 ...
 */
class SubmitPreprocessJobs extends RpcRequest
{
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withPreprocessType() instead.
     *
    ...
    {
        return $this->withPreprocessType($preprocessType);
    }
